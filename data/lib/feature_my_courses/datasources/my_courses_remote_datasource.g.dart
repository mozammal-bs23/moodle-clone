...
part of 'my_courses_remote_datasource.dart';
...
class _MyCoursesRemoteDatasource implements MyCoursesRemoteDatasource {
  _MyCoursesRemoteDatasource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<List<CourseModel>> getMyCourses({
    ...
    required String moodlewsrestformat,
